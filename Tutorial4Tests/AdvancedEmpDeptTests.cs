...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnMaxSalary()
    {
        ...
        decimal? maxSalary = emps.Max(a=>a.Sal); 
    ...
    public void ShouldReturnMinSalaryInDept30()
    {
        ...
        decimal? minSalary = emps.Where(a=>a.DeptNo==30).Min(a=>a.Sal);
    ...
    public void ShouldReturnFirstTwoHiredEmployees()
    {
        var emps = Database.GetEmps();
         ...
         var firstTwo = emps.OrderByDescending(a=>a.HireDate).Take(2).ToList(); 
    ...
    public void ShouldReturnEmployeesWithManagers()
    {
        var emps = Database.GetEmps();
         ...
         var withMgr = emps.Where(a=> a.Mgr is not null).ToList(); 
    ...
    public void AllEmployeesShouldEarnMoreThan500()
    {
        var emps = Database.GetEmps();
         ...
         var result = emps.All(a=>a.Sal>500); 
    ...
    public void ShouldFindAnyWithCommissionOver400()
    {
        var emps = Database.GetEmps();
         ...
         var result = emps.Any(a=>a.Comm>400);
    ...
    // SQL: SELECT EName, (Sal + COALESCE(Comm, 0)) AS Total FROM Emp;
    [Fact]
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = emps.Join(depts, 
            ...
            (ed, grade) => new
            {
                ed.EName,
                ed.DName,
                Grade = grades.Where(a=> ed.Sal>a.Losal && ed.Sal<=a.Hisal).Select(a=>a.Grade).FirstOrDefault()
            }
            ).ToList();
